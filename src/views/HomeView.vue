...
<template>
  <div class="container">
    ...
    <div class="content">
      <Transition>
        <div
          v-if="activeSection === 'home' || activeSection === 'about'"
          class="section"
          id="about">
          ...
          <p>
            That's where I found my passion for front-end website development when I was 14 years
            old. The community inspired me to learn HTML and CSS so that I could create beautiful
            layouts for the guilds I became a part of.
          </p>
          <p>
            I attended
            <a
            ...
            changed, and where it is going. While honing my coding skills, my fascination with
            fossils and rocks, and what they could tell us about Earth's past and future, led me to
            pursue a B.A. in Earth and Environmental Sciences.
          </p>
          <p>
            ...
            Lead, overseeing the operations of the Grocery and Starbucks departments. I led a team
            of 18 to ensure the floor was fully stocked with fresh fruits, veggies, and pasta while
      ...
      <Transition>
        <div
          v-if="activeSection === 'home' || activeSection === 'experience'"
          class="section"
          id="experience">
